...
public class Constants {
	...
	*/
    public static final int ConfigVersion = 2;
            // Increment this when the config file format changes
    public static final Setting<Integer> ConfigVersionSetting =
            Settings.intSetting("ConfigVersion", ConfigVersion, 0, Integer.MAX_VALUE);
    ...
    /**
     * Used for any value that is 256 but is not related to world height
     */
    public static final int OTHER_256 = 256;

    public static final OTGWorldInfo DEFAULT_WORLD_INFO =
            new OTGWorldInfo(WORLD_DEPTH, WORLD_HEIGHT);

    public static final int WORLD_START_MIN_Y = -2032;
            // Minimum possible Y value the world can start at
    public static final int WORLD_END_MAX_Y = 2031;
            // Maximum possible Y value the world can end at
    public static final int WORLD_MAX_HEIGHT = WORLD_END_MAX_Y - WORLD_START_MIN_Y + 1;
            // Maximum possible height of the world, based on min and max Y values - 4064
    ...
    public static final String StructureDataBackupFileExtension =
            BackupFileSuffix + StructureDataFileExtension;
    public static final String PlottedChunksDataFolderName =
            StructureDataFolderName + File.separator + "PlottedChunks";
    // Data about structure start points and bo4 groups, used for distance.
    public static final String SpawnedStructuresFileName = StructureDataFolderName
                                                           + File.separator
                                                           + "SpawnedStructures"
                                                           + StructureDataFileExtension;
    public static final String SpawnedStructuresBackupFileName = StructureDataFolderName
                                                                 + File.separator
                                                                 + "SpawnedStructures"
                                                                 + StructureDataBackupFileExtension;
    ...
    public static final String MOD_LABEL_EXCLUDE =
            LABEL_EXCLUDE + MOD_LABEL;
    public static final String BIOME_CATEGORY_LABEL_EXCLUDE =
            LABEL_EXCLUDE + BIOME_CATEGORY_LABEL;
    public static final String MOD_BIOME_CATEGORY_LABEL_EXCLUDE =
            LABEL_EXCLUDE + MOD_BIOME_CATEGORY_LABEL;
    public static final String MC_BIOME_CATEGORY_LABEL_EXCLUDE =
            LABEL_EXCLUDE + MC_BIOME_CATEGORY_LABEL;
    public static final String BIOME_DICT_TAG_LABEL_EXCLUDE =
            LABEL_EXCLUDE + BIOME_DICT_TAG_LABEL;
    public static final String MOD_BIOME_DICT_TAG_LABEL_EXCLUDE =
            LABEL_EXCLUDE + MOD_BIOME_DICT_TAG_LABEL;
    public static final String MC_BIOME_DICT_TAG_LABEL_EXCLUDE =
            LABEL_EXCLUDE + MC_BIOME_DICT_TAG_LABEL;
}
